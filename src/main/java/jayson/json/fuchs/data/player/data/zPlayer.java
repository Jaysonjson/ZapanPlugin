package jayson.json.fuchs.data.player.data;

import jayson.json.fuchs.Utility;
import jayson.json.fuchs.data.guild.obj.zPlayerClass;
import jayson.json.fuchs.data.interfaces.IHasUUID;
import jayson.json.fuchs.data.player.obj.zHealth;
import jayson.json.fuchs.data.player.obj.zLevel;
import jayson.json.fuchs.data.player.obj.zPlayerSpecial;
import jayson.json.fuchs.data.player.obj.zStats;

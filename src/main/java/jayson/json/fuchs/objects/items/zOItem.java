...
import jayson.json.fuchs.objects.items.nbt.NBTType;
...
public class zOItem {
    ...
    public zOItem(AbstractItem zItem, Player player, ItemStack itemStack) {
        this.item = itemStack;
        this.itemMeta = this.item.getItemMeta();
        this.lore = new ArrayList<>();
        this.id = zItem.getId();
    ...
    public zOItem(AbstractItem zItem, Player player, ItemStack itemStack, boolean textureDamage) {
        this.item = itemStack;
        this.itemMeta = this.item.getItemMeta();
        this.lore = new ArrayList<>();
        this.id = zItem.getId();

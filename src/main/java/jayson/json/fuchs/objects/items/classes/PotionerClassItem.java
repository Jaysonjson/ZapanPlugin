package jayson.json.fuchs.objects.items.classes;
...
public class PotionerClassItem extends AbstractItem {

    public PotionerClassItem(String id, Material material, ItemUseType itemUseType) {
